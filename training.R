...
replace_values <- function(x) {
  ifelse(x < -90,x<- -90,ifelse(x > -30,x <- -30, x <- x))
}
...
# phones ####
#### Ignacio: Phone signal analysis. This is no longer needed as you already 
#### fixed the WAPs signal strengths just cutting of the d
